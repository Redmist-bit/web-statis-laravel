...
@section('content')
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Input Pertanyaan anda</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="datein" name="datein" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" im-insert="false" placeholder="yyyy/mm/dd">
                    </div>
                  <div class="form-group">
                    <label>Tanggal dibuat</label>
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="dateout" name="dateout" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" im-insert="false" placeholder="yyyy/mm/dd">
                  </div>
                  <!-- <div class="form-group">
